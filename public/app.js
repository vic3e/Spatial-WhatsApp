...
var handleSignedOutUser = function() {
  ...
  document.getElementById('choose-next-pages').style.display = 'none';
...
firebase.auth().onAuthStateChanged(function(user) {
  ...
  document.getElementById('choose-next-pages').style.display = 'block';
...
var nextPageButtonClick = function(clicked){
  console.log(this.id);
  if(this.id === 'go-to-friend-list'){
    window.location.assign('/friend-list.html');
  }
  if(this.id === 'go-to-chat-app'){
    window.location.assign('/chat-app.html');
...
var initApp = function() {
  ...
  document.getElementById('go-to-friend-list').addEventListener(
    'click', nextPageButtonClick);
  
  document.getElementById('go-to-chat-app').addEventListener(
    'click', nextPageButtonClick);
};
